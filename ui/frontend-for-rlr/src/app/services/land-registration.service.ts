...
export class LandRegistrationService {
  ...
  // change current owner vote in the block chain
  public changeCurrentOwnerVote(landID: string, vote: number) {
    return this.httpService.realizarHttpPost('/bc/land/changeCurrentOwnerVote/', 
    { 
      id: landID, 
      vote: vote
    });
